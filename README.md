...
- `Rats.csv`: Subject list with birth dates and vaccination dates
- `Games.tsv`: Available games with difficulty (number of options) and correct answers
- `Tests.csv`: Full test results across all subjects and sessions
